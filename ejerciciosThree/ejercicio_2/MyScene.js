...
class MyScene extends THREE.Scene {
   constructor(myCanvas) {
      ...
      // La escena no tiene ejes, los tendrá cada uno de los objetos para si mismos
      ...
      this.box = new Box(this.gui, "Controles de la Caja");
      this.add(this.box);
      ...
      this.torus = new Torus(this.gui, "Controles del Toro");
      this.add(this.torus);
