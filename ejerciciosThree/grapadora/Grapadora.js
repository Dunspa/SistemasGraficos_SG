...
class Grapadora extends THREE.Object3D {
   constructor(gui,titleGui) {
      ...
      // Al nodo que contiene la transformación interactiva que abre y cierra la
      // grapadora se accede desde el método update, se almacena en un atributo.
   ...
   createMovil () {
      ...
      // IMPORTANTE: Con independencia del orden en el que se escriban las 2 líneas siguientes
      // SIEMPRE se aplica primero la rotación y después la traslación.
      // Prueba a intercambiar las dos líneas siguientes y verás que no se produce ningún cambio al ejecutar.
