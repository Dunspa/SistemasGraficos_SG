...
/**
 * Usaremos una clase derivada de la clase Scene de Three.js para llevar el control de la escena y
...
class MyScene extends THREE.Scene {
   ...
   update () {
      ...
      // Literalmente le decimos al navegador: "La próxima vez que haya que refrescar
      // la pantalla, llama al método que te indico".
...
$(function () {
   ...
   // Se añaden los listener de la aplicación. En este caso, el que va a comprobar
   // cuándo se modifica el tamaño de la ventana de la aplicación.
